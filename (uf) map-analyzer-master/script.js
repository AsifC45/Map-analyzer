...
function initMap() {
	...
	// Add Page Tabs
	for (let numLevel = 1; numLevel <= 12; numLevel++) {
...
function initMapData() {
	...
	// Level 7: Vertical Chained - Four Bars
	mapData["Level 7"] = [
	...
	// Level 8: Binary - Corner Box & Remaining Area
	mapData["Level 8"] = [
	...
	// Level 11: Binary - Center Box & Remaining Area
	mapData["Level 11"] = [
	...
	// Level 12: Chained - Two Boxes & Remaining Area
	mapData["Level 12"] = [
		["ground", "ground", "ground", "ground", "ground", "ground", "ground", "ground", "ground", "ground", "ground", "ground"],
